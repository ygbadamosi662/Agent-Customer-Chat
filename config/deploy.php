...
return [
    ...
    'options' => [
        'application' => env('APP_NAME', 'admin.ogaranya.com'),
        'repository' => 'https://Massivebrains:Adeshola18@bitbucket.org/Massivebrains/admin.ogaranya.com.git',
    ],
    ...
    'hosts' => [
        '139.59.187.74' => [
            'deploy_path' => '/var/www/admin.ogaranya.com',
            'user' => 'root',
        ],
    ],
